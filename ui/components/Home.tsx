...
const Buttons = () => (
  <View style={styles.buttons}>
    <Button size={"giant"} appearance={"outline"} status={"control"}>
      Off
    </Button>
    <Button size={"giant"} appearance={"outline"} status={"primary"}>
      Circulate
    </Button>
    <Button size={"giant"} appearance={"outline"} status={"warning"}>
      Heat
    </Button>
  </View>
);
